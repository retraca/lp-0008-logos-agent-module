...
- **lint**: ✅ green.
- **e2e**: manual `workflow_dispatch` (real-proof run, minutes/proof; reproducible via `tests/demo-real.sh`, recorded in `docs/lp0008-demo.mp4`).
...
The module **builds and runs locally** with the platform modules present (see `EVIDENCE_LOCAL.md`, `TESTNET_EVIDENCE.md`, `F8_AUTONOMOUS_PAYMENT_EVIDENCE.md`).
